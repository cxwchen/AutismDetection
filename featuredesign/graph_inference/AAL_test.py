...
def graphing(A, community_method=None, feats=False, plot=False, deg_trh=0, alpha=0e-0):
    """
...
def multiset_feats(data_list, filenames, subject_ids):
    """
    ...
    for data, sid in zip(data_list, subject_ids):
        ...
        df_graph, df_global = graphing(A= pearson_corr(data)[1], feats=True, plot=False) # Compute the graphical features
